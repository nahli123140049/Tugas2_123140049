        ...
        NavHost(
            ...
            composable(Screen.AddNote.route) {
                AddNoteScreen(
                    ...
                    aiState = aiState,
                    onSummarize = { aiViewModel.summarizeNote(it) },
                    onRewrite = { aiViewModel.rewriteNote(it) },
                    onTranslate = { aiViewModel.translateNote(it) },
                    onClearAiState = { aiViewModel.clearState() }
                )
            }
